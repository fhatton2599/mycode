...
def main():
    ...
    devicecmd = {"10.1.0.1":["interface eth1/2", crayons.green("no shutdown")], "10.2.0.1":
    ["interface eth1/1", crayons.red("shutdown")], "10.3.0.1":["interface eth1/5", crayons.green("no shutdown")]}
